...
var _NodeInfoView = __webpack_require__(7);

var _NodeInfoView2 = _interopRequireDefault(_NodeInfoView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('AE.History/Views/NodeInfoView', {}, function (globalRegistry) {
    var viewsRegistry = globalRegistry.get('inspector').get('views');

    viewsRegistry.set('AE.History/Views/NodeInfoView', {
        component: _NodeInfoView2.default
    });
});
...
var NodeInfoView = (_dec = (0, _reactRedux.connect)(function (state) {
    return {
    ...
    function NodeInfoView() {
        _classCallCheck(this, NodeInfoView);

        return _possibleConstructorReturn(this, (NodeInfoView.__proto__ || Object.getPrototypeOf(NodeInfoView)).apply(this, arguments));
    }

    _createClass(NodeInfoView, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'ul',
                { className: _style2.default.nodeInfoView },
                _react2.default.createElement(
                    'li',
                    { className: _style2.default.nodeInfoView__item, title: new Date(properties.created).toLocaleString() },
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.nodeInfoView__title },
                ...
                _react2.default.createElement(
                    'li',
                    { className: _style2.default.nodeInfoView__item, title: new Date(properties.lastModification).toLocaleString() },
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.nodeInfoView__title },
                    ...
                    _react2.default.createElement(
                        NodeInfoViewContent,
                        null,
                        !nodeTypesRegistry.isOfType(nodeType, 'Neos.Neos:Document') ? new Date(properties.lastModification).toLocaleString() : _react2.default.createElement(
                            'a',
                            { href: '/neos/management/history/?moduleArguments%5BnodeIdentifier%5D=' + properties.identifier, className: _style2.default.link },
                ...
                properties.lastPublication ? _react2.default.createElement(
                    'li',
                    { className: _style2.default.nodeInfoView__item, title: new Date(properties.lastPublication).toLocaleString() },
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.nodeInfoView__title },
                ...
                _react2.default.createElement(
                    'li',
                    { className: _style2.default.nodeInfoView__item, title: properties.identifier },
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.nodeInfoView__title },
                ...
                _react2.default.createElement(
                    'li',
                    { className: _style2.default.nodeInfoView__item, title: properties.path },
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.nodeInfoView__title },
                ...
                _react2.default.createElement(
                    'li',
                    { className: _style2.default.nodeInfoView__item, title: nodeType },
                    _react2.default.createElement(
                        'div',
                        { className: _style2.default.nodeInfoView__title },
...
exports.default = NodeInfoView;
var NodeInfoViewContent = (_temp3 = _class3 = function (_PureComponent2) {
    _inherits(NodeInfoViewContent, _PureComponent2);

    function NodeInfoViewContent() {
        var _ref;

        var _temp2, _this2, _ret;

        _classCallCheck(this, NodeInfoViewContent);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref = NodeInfoViewContent.__proto__ || Object.getPrototypeOf(NodeInfoViewContent)).call.apply(_ref, [this].concat(args))), _this2), _this2.handleReference = function (ref) {
            _this2.element = ref;
    ...
    _createClass(NodeInfoViewContent, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                {
                    ...
                    className: _style2.default.nodeInfoView__content,
...
// module
exports.push([module.i, ".style__nodeInfoView___mYbQ4 {\n    background-color: #323232;\n    margin: 0;\n    padding: 0;\n    list-style: none;\n}\n\n    .style__nodeInfoView__item___3rmzo {\n        padding: 8px;\n        border-bottom: 1px solid #222;\n        line-height: 20px;\n        min-height: 20px;\n    }\n\n    .style__nodeInfoView__item___3rmzo:last-child {\n            border-bottom: none;\n        }\n\n    .style__nodeInfoView__title___3tt-4 {\n        font-weight: bold;\n    }\n\n    .style__nodeInfoView__content___1z3ez {\n        font-size: 13px;\n    }\n\n.style__link___23seG {\n    color: #ff8700;\n}\n\n.style__link___23seG:hover {\n        text-decoration: underline;\n    }\n", ""]);

// exports
exports.locals = {
	"nodeInfoView": "style__nodeInfoView___mYbQ4",
	"nodeInfoView__item": "style__nodeInfoView__item___3rmzo",
	"nodeInfoView__title": "style__nodeInfoView__title___3tt-4",
	"nodeInfoView__content": "style__nodeInfoView__content___1z3ez",
	"link": "style__link___23seG"
};
